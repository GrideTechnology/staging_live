...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	DB::table('permissions')->insert([
            ...
            ['name' => 'referral', 'display_name' => 'referral', 'guard_name' => 'admin', 'group_name' => 'referral'],
        ...
        $fleet_permissions = Permission::select('id')->whereIn('name', ['dashboard-menus','provider-list','provider-create','provider-edit','provider-delete','provider-status','provider-history','provider-statements','provider-rating','heat-map','god-eye','referral','account-settings','change-password'])->get();
