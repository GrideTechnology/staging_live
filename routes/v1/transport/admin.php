...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->get('/getvehicletype', 'V1\Transport\Admin\VehicleController@getvehicletype');
		...
		$app->delete('/vehicle/{id}', ['middleware' => 'demo', 'uses' => 'V1\Transport\Admin\VehicleController@destroy']);

		$app->get('/transport/price/get/{id}', 'V1\Transport\Admin\VehicleController@gettaxiprice');

		$app->get('/transport/getcompanycountrylist', 'V1\Transport\Admin\VehicleController@getcompanycountry');

		$app->get('/transport/getcompanystatelist/{id}', 'V1\Transport\Admin\VehicleController@getcompanystatelist');

		$app->get('/transport/getcompanycitylist/{id}', 'V1\Transport\Admin\VehicleController@getcompanycitylist');
		...
		$app->get('/rideprice/{ride_delivery_vehicle_id}/{state_id}/{city_id}', 'V1\Transport\Admin\VehicleController@getRidePrice');
		...
		$app->delete('/requestStatementhistory/{id}', 'V1\Transport\User\RideController@destroy');
		...
		$app->delete('/vehicletype/{id}', ['middleware' => 'demo', 'uses' => 'V1\Transport\Admin\VehicleTypeController@destroy']);
		...
		//Car brand list
		$app->get('/brand', 'V1\Transport\Admin\CarBrandController@index');
		$app->post('/brand','V1\Transport\Admin\CarBrandController@store');
		$app->put('/brand/{id}', 'V1\Transport\Admin\CarBrandController@update');
		$app->delete('/brand/{id}', 'V1\Transport\Admin\CarBrandController@destroy');
