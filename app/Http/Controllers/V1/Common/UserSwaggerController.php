...
class UserSwaggerController extends Controller
{
	...
	*			@OA\Schema(ref="#/components/schemas/UserSendOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	*		@OA\JsonContent(ref="#/components/schemas/UserSendOTP")),
	*	@OA\Response(
	*		response="422",
	...
	*/ 
	/**
	*@OA\Schema(
	*	schema="UserSendOTPInput",
	*	type="object",
	*	allOf={
	*	@OA\Schema(ref="#/components/schemas/UserSendOTP"),
	*	@OA\Schema(
	*		@OA\Property(property="country_code", type="string"),
	*		@OA\Property(property="mobile", type="string"),
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserVerifyOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	*		@OA\JsonContent(ref="#/components/schemas/UserVerifyOTP")),
	*	@OA\Response(
	*		response="422",
	*		description="Error: Unprocessable entity. When required parameters were not supplied."),
	* )
	*/
	/**
	* @OA\Schema(schema="UserVerifyOTP", 
	...
	*/ 
	/**
	*@OA\Schema(
	*	schema="UserVerifyOTPInput",
	*	type="object",
	*	allOf={
	*	@OA\Schema(ref="#/components/schemas/UserVerifyOTP"),
	*	@OA\Schema(
	*		@OA\Property(property="country_code", type="string"),
	*		@OA\Property(property="mobile", type="string"),
	*		@OA\Property(property="otp", type="string"),
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserProfileUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserPasswordUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserLanguageUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*		mediaType="multipart/form-data",
	*		@OA\Schema(ref="#/components/schemas/UserCountriesInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*		mediaType="multipart/form-data",
	*		@OA\Schema(ref="#/components/schemas/UserDeviceTokenInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UsercardUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserAddMoneyInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	**********************************************************************/
	...
	/**
	*@OA\Post(
	*	path="/api/v1/user/wallet/transfer",
	*	operationId="api.v1.user.wallet.transfer",
	*	tags={"User Wallet Transfer"},
	*	description="User Wallet Transfer",
	*	@OA\RequestBody(
	*		description="User Wallet Transfer",
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserWalletMoneyInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Wallet amount successfully transferred",
	*		@OA\JsonContent(ref="#/components/schemas/UserWalletMoney")),
	*	@OA\Response(
	*		response="422",
	*		description="Error: Unprocessable entity. When required parameters were not supplied."),
	*	security={ {"User": {}} },
	...
	*/
	/**
	* @OA\Schema(schema="UserWalletMoney", 
	* 	required={"amount","id"},
	...
	*/ 
	...
	/**
	*@OA\Schema(
	*	schema="UserWalletMoneyInput",
	*	type="object",
	*	allOf={
	*	@OA\Schema(ref="#/components/schemas/UserWalletMoney"),
	*	@OA\Schema(
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserAddAddressInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserUpdateAddressInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Address added to user",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserChangeCityInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Address added to user",
