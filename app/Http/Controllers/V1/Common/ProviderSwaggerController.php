...
class ProviderSwaggerController extends Controller
{
	...
	*			@OA\Schema(ref="#/components/schemas/ProviderSendOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	*		@OA\JsonContent(ref="#/components/schemas/ProviderSendOTP")),
	*	@OA\Response(
	*		response="422",
	...
	*/
	/**
	* @OA\Schema(schema="ProviderSendOTP", 
	* 	required={"country_code","mobile","salt_key"}, 
	...
	*/ 
	/**
	*@OA\Schema(
	*	schema="ProviderSendOTPInput",
	*	type="object",
	*	allOf={
	*	@OA\Schema(ref="#/components/schemas/ProviderSendOTP"),
	*	@OA\Schema(
	*		@OA\Property(property="country_code", type="string"),
	*		@OA\Property(property="mobile", type="string"),
	...
	**********************************************************************/
	...
	/**
	*@OA\Post(
	*	path="/api/v1/provider/verify-otp",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderVerifyOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	*		@OA\JsonContent(ref="#/components/schemas/ProviderVerifyOTP")),
	*	@OA\Response(
	*		response="422",
	*		description="Error: Unprocessable entity. When required parameters were not supplied."),
	* )
	*/
	/**
	* @OA\Schema(schema="ProviderVerifyOTP", 
	* 	required={"country_code","mobile","otp","salt_key"}, 
	*	@OA\Property(property="country_code", type="string" ),
	*	@OA\Property(property="mobile", type="string" ),
	...
	*/ 
	/**
	*@OA\Schema(
	*	schema="ProviderVerifyOTPInput",
	*	type="object",
	*	allOf={
	*	@OA\Schema(ref="#/components/schemas/ProviderVerifyOTP"),
	*	@OA\Schema(
	*		@OA\Property(property="country_code", type="string"),
	*		@OA\Property(property="mobile", type="string"),
	*		@OA\Property(property="otp", type="string"),
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderProfileUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderPasswordUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderLanguageUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*		mediaType="multipart/form-data",
	*		@OA\Schema(ref="#/components/schemas/ProviderDeviceTokenInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="updated successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderCardUpdateInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderAddMoneyInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	**********************************************************************/
	...
	/**
	*@OA\Post(
	*	path="/api/v1/provider/wallet/transfer",
	*	operationId="api.v1.provider.wallet.transfer",
	*	tags={"Provider Wallet Transfer"},
	*	description="Provider Wallet Transfer",
	*	@OA\RequestBody(
	*		description="Provider Wallet Transfer",
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderWalletMoneyInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Wallet amount successfully transferred",
	*		@OA\JsonContent(ref="#/components/schemas/ProviderWalletMoney")),
	*	@OA\Response(
	*		response="422",
	*		description="Error: Unprocessable entity. When required parameters were not supplied."),
	*	security={ {"Provider": {}} },
	...
	*/
	/**
	* @OA\Schema(schema="ProviderWalletMoney", 
	* 	required={"amount","id"}, 
	*	@OA\Property(property="id", type="varchar",example="1",description="sender Id" ),
	*	@OA\Property(property="mobile", type="integer",example="9874563210",description="Mobile Number" ),
	*	@OA\Property(property="amount", type="integer", example="100" ))
	* 
	*/ 
	/**
	*@OA\Schema(
	*	schema="ProviderWalletMoneyInput",
	*	type="object",
	*	allOf={
	*	@OA\Schema(ref="#/components/schemas/ProviderWalletMoney"),
	*	@OA\Schema(
	*		@OA\Property(property="id", type="varchar"),
	*		@OA\Property(property="mobile", type="integer"),
	*		@OA\Property(property="amount", type="integer"))
	*	}
	* )
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderAddBankDetailsInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderEditBankDetailsInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Updated Successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderDocumentsListInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderDocumentsInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderVehicleInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="created successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderEditVehicleInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Updated Successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderClearRequestInput"))
	*	),
	*	@OA\Response(
	*		response="200",
