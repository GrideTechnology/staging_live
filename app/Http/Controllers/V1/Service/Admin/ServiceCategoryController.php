...
class ServiceCategoryController extends Controller
{
    ...
    {
        $datum = ServiceCategory::where(['company_id' => Auth::user()->company_id])->whereIn('service_category_status',[0,1]);
    ...
    public function destroy($id)
    {
        ...
        if($ServiceCategory){
            ...
            $ServiceCategory->deleted_at = \Carbon\Carbon::now();
            $ServiceCategory->deleted_type = Auth::user()->type;
