...
class ServicesController extends Controller
{
    ...
    {
        $datum = Service::with('serviceCategory')->with('subCategories')->where('company_id', Auth::user()->company_id)->whereIn('service_status',[0,1]);
    ...
    public function destroy($id)
    {
        ...
        if($SubCategory){
            $SubCategory->service_status = 2;
            $SubCategory->deleted_at = \Carbon\Carbon::now();
            $SubCategory->deleted_type = Auth::user()->type;
