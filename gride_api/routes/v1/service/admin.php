...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->group(['prefix'=>'service'], function($app){
        ...
        $app->get('/servicecompanydocuments/{id}', 'V1\Service\User\ServiceController@webcompanyproviderservice');
        ...
        $app->delete('/requestStatementhistory/{id}', 'V1\Service\User\ServiceController@destroy');
