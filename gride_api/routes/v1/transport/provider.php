...
$router->group(['middleware' => 'auth:provider'], function($app) {
	...
	$app->post('/ride/accept', 'V1\Transport\Provider\TripController@accept_ride');
    ...
    $app->post('/transport/create-provider-account', 'V1\Transport\Provider\TripController@createprovideraccount');
    $app->post('/transport/transfer-payment', 'V1\Transport\Provider\TripController@TransferPayment');
	...
	$app->get('/ridetype/{type}', 'V1\Transport\Provider\HomeController@ridetypebyService');
	$app->get('/vehicles/{type}', 'V1\Transport\Provider\HomeController@ProviderVehicles');
	$app->get('/vehicles/{type}/{id}', 'V1\Transport\Provider\HomeController@ProviderVehiclesById');
	$app->post('/vehicles/{id}', 'V1\Transport\Provider\HomeController@DefaultVehicle');
