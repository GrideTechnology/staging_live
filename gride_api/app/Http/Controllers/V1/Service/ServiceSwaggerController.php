...
class ServiceSwaggerController extends Controller
{
	...
	*			@OA\Schema(ref="#/components/schemas/CreateServiceInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	* 			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserCancelServiceInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/ServiceUpdatePaymentInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns available services, providers and promocodes",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/UserServicePaymentInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns available services, providers and promocodes",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/UserServiceRatingInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns available services, providers and promocodes",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/ProviderCancelServiceInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns available services, providers and promocodes",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/UpdateServiceRequestInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns available services, providers and promocodes",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/ProviderServiceRatingInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns available services, providers and promocodes",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/UserServiceDisputeInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/ProviderServiceDisputeInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns Saved Successfully",
