...
class CommonSwaggerController extends Controller
{
	...
	*				@OA\Schema(ref="#/components/schemas/UserLoginInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*	@OA\Property(property="email", type="string", example="demo@demo.com" ),
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserSignupInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserSocialLoginInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserForgotInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*		mediaType="multipart/form-data",
	*		@OA\Schema(ref="#/components/schemas/UserResetInput")
	*		)),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*		mediaType="multipart/form-data",
	*		@OA\Schema(ref="#/components/schemas/UserVerifyInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*	@OA\MediaType(
	*		mediaType="multipart/form-data",
	*		@OA\Schema(ref="#/components/schemas/ProviderLoginInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderSignupInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/ProviderForgotInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	* 			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/ProviderResetInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	* 			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/AcceptRequestInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	* 			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/CancelRequestInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\Schema(ref="#/components/schemas/UserAddChatInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*				@OA\Schema(ref="#/components/schemas/ShopLoginInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Returns settings for the application",
	*		@OA\JsonContent(ref="#/components/schemas/ShopLogin")),
	*	@OA\Response(
	*		response="422",
	*		description="Error: Unprocessable entity. When required parameters were not supplied."))
	*/
	/**
	*@OA\Schema(schema="ShopLogin", 
	*	@OA\Property(property="email", type="string", example="kfc@demo.com" ),
	*	@OA\Property(property="device_type", type="string", enum={"ANDROID", "IOS", "MANUAL"}  ),
	*	@OA\Property(property="device_token", type="string"),
	*	@OA\Property(property="password", type="string", example="123456" ),
	*	@OA\Property(property="salt_key", type="string", example="MQ==" ))
	...
	*/
	/**
	*@OA\Schema(
	*	schema="ShopLoginInput",
	*	type="object",
	*	allOf={
	*		@OA\Schema(ref="#/components/schemas/ShopLogin"),
	*		@OA\Schema(
	*			@OA\Property(property="email", type="string"),
	*			@OA\Property(property="password", type="string"),
	*			@OA\Property(property="device_type", type="string"),
