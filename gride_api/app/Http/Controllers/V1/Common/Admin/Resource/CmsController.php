...
class CmsController extends Controller
{
    ...
    public function upload(Request $request)
    {
        ...
        //     $path= Helper::upload_file($request->file('upload'), 'cmspage');
        // }
        // $CKEditorFuncNum = $request->input('CKEditorFuncNum');
        // $msg = 'Image successfully uploaded'; 
        // $re = "<script>window.parent.CKEDITOR.tools.callFunction($CKEditorFuncNum, '$path', '$msg')</script>";
        // // Render HTML output 
        // @header('Content-type: text/html; charset=utf-8'); 
        // echo $re;
        // return response()->json(['fileName' => 'dssd', 'uploaded'=> 1, 'url' => $path]);
