...
{
    use HasRoles, Authenticatable, Authorizable, Notifiable;
    ...
    protected $fillable = [
        ...
        'name', 'email','mobile','country_code','password','company_id','picture','type','country_id','city_id',"zone_id",'commision','company_name','currency_symbol','deleted_at','is_deleted'
    ];
