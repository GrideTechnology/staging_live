...
class ProviderService extends BaseModel
{
	...
	protected $fillable = [
        'provider_id', 'company_id', 'category_list', 'admin_service', 'provider_vehicle_id', 'ride_delivery_id', 'status', 'deleted_type', 'deleted_by'
    ];
	
    protected $hidden = [
     	'created_type', 'created_by', 'modified_type', 'modified_by', 'created_at', 'updated_at', 'deleted_at'
    ];
