...
class Services {
    ...
    public function create_service(Request $request){
        ...
        $Provider = Provider::with('service','rating')
            ->select(DB::Raw("(3959 * acos( cos( radians('$latitude') ) * cos( radians(latitude) ) * cos( radians(longitude) - radians('$longitude') ) + sin( radians('$latitude') ) * sin( radians(latitude) ) ) ) AS distance"),'id','first_name','picture')
